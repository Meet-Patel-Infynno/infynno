  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "back-image-welcome": "url('/images/back-welcome.svg')",
        "contact-image": "url('/images/contact-us.svg')",
        "testimonial-back": "url('/images/testimonial-back.svg')",
        "header-back": "url('/images/header-back.svg')",
        "blog-back": "url('/images/blog.svg')",
      },
      backgroundColor: {
