...
const ResetPassword = () => {
  ...
  return (
    <section className="flex min-h-auth-screen xs:mb-14 md:mb-0 flex-col md:gap-16 md:flex-row md:px-12 sm:justify-between max-w-5xl mx-auto items-center">
      <div className="absolute top-7 left-7 sm:left-14 md:left-24 md:top-14" >
        <BackArrow />
      </div>
      <div className="px-28 mt-5 md:px-6">
